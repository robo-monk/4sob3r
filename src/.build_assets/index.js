...
//function injectStyle(name){
    //if (! name in styles) return console.error(`could not find ${name}.scss in 4sob3r/src/styles`) 
    //pragmajs.util.addStyles(styles[name])
//}

//function SVG(name, fill) {
    //if (! name in icons) return console.error(`could not find ${name}.scss in 4sob3r/src/styles`)
    //let i = icons[name]
